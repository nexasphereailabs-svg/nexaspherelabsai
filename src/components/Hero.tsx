...
>>>>>>> e3d7982 (changes made)
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative z-10 glass rounded-[40px] p-4 overflow-hidden group">
            <div className="absolute inset-0 bg-gradient-to-tr from-brand-violet/10 to-brand-cyan/10 opacity-50 group-hover:opacity-70 transition-opacity" />
            <img 
              src="https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=2000" 
              alt="AI Visualization" 
              className="rounded-[32px] shadow-xl relative z-20 transition-all duration-700"
            />
          </div>
