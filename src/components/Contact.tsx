          ...
          >
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-bold uppercase tracking-widest text-slate-500 mb-3 px-1">Full Name</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="block text-xs font-bold uppercase tracking-widest text-slate-500 mb-3 px-1">Email address</label>
                  <input 
                    type="email" 
              ...
              <div>
                <label className="block text-xs font-bold uppercase tracking-widest text-slate-500 mb-3 px-1">Subject</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-xs font-bold uppercase tracking-widest text-slate-500 mb-3 px-1">Message</label>
                <textarea 
                  rows={4}
              ...
              <Button className="w-full py-5 text-lg font-bold flex items-center justify-center gap-3 bg-slate-900 text-white hover:bg-slate-800 transition-colors">
